...
const Top10Comparison: React.FC = () => {
  ...
  const a5Top10 = [...data.a5].sort((a, b) => b.max_listings_per_cell - a.max_listings_per_cell).slice(0, 10);

  const h3Top10 = [...data.h3].sort((a, b) => b.max_listings_per_cell - a.max_listings_per_cell).slice(0, 10);
          ...
          {a5Top10.map((city, index) => {
            ...
            return (
              ...
              >
                ...
                <span style={{fontSize: '15px', color: '#374151'}}>{formatCityName(city.location)}</span>
              </div>
            );
          })}
        </div>
