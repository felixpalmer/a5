    ...
    <>
      <group position={[-2.6, 0, 3.8]}>
        ...
        <mesh geometry={mergedGeometry}>
          <meshBasicMaterial map={earthTexture} depthTest={false} side={DoubleSide} />
        </mesh>
      </group>
    ...
    >
      ...
      >
        ...
        >
          <input
            ...
            style={{width: '300px'}}
          />
          <div style={{textAlign: 'center', fontSize: '12px'}}>Longitude Offset: {lonOffset}°</div>
        </div>
      </div>
      ...
      >
        <input
          ...
          style={{width: '300px'}}
        />
        <div style={{textAlign: 'center', fontSize: '12px'}}>Resolution: {resolution}</div>
      </div>
