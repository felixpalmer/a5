...
function Scene({
  ...
  const currentDistance =
    mainSphereRadius + (dimpleSqueeze == 1.0 ? 0.995 : 1.01) * dimpleRadius * Math.cos(dimpleAngle);
        ...
        {dimplePositions.map(({center, up}, index) => {
          ...
          return (
            <group key={index}>
              ...
              <mesh renderOrder={1} position={position} rotation={rotation} scale={new Vector3(dimpleSqueeze, 1, 1)}>
